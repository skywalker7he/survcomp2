...
* The dataset consist of `r nrow(bcsurg)` observations and `r ncol(bcsurg)` variables.
...
* The main variable of interest is `Groups`, which encompasses `r length(unique(bcsurg$Groups))` subgroups of breast cancer patients; they are: Luminal A (0), Luminal B (1), Triple Negative (2), Her2 Enriched (3), and Triple Positive (4). 
...
survcomp_plot(dat = bcsurg, patid = "ID..", 
...
```{r}
emm_contrasts <- survcomp(dat = bcsurg, patid = "ID..",
