...
* The dataset consist of `r nrow(dat)` observations and `r ncol(dat)` variables.
...
* The main variable of interest is `Groups`, which encompasses `r length(unique(dat$Groups))` subgroups of breast cancer patients; they are: Luminal A (0), Luminal B (1), Triple Negative (2), Her2 Enriched (3), and Triple Positive (4). 
